...
const BUSINESS_CONFIG = {
  PHONE_NUMBER: "491746355261", // Active WhatsApp Business number
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
            ...
            <div className="text-center lg:text-right order-2 lg:order-1">
              <div className="inline-flex items-center gap-2 bg-brand-50 px-4 py-1.5 rounded-full mb-6 border border-brand-100">
                ...
                <span className="text-sm font-semibold text-brand-700">شرح فوري ودقيق عبر الواتساب ⚡</span>
              </div>

              <h1 className="text-4xl md:text-6xl font-extrabold text-gray-900 mb-6 leading-[1.2]">
                شرح الوثائق الألمانية <br className="hidden md:block"/>
              ...
              <p className="text-lg text-gray-600 mb-8 max-w-lg mx-auto lg:mx-0 leading-relaxed">
                صور وثيقتك الألمانية، أرسلها عبر الواتساب، واحصل على شرح واضح بالعربي في أقل من 30 ثانية.
                فوري • دقيق • بسيط
              </p>
