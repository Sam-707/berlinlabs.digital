...
const TableGridView: React.FC<TableGridViewProps> = ({ onSelectTable, onBack }) => {
  ...
  return (
    <div className="flex flex-col h-full bg-[#170e10] text-white animate-fade-in overflow-hidden relative">
        ...
        <div className="grid grid-cols-4 gap-3">
          {tables.map(num => (
            <button
              ...
              className="aspect-square rounded-2xl bg-[#241619] border border-white/5 flex flex-col items-center justify-center gap-1 active:scale-90 transition-all shadow-lg active:bg-primary active:border-primary group"
            >
      ...
      <footer className="p-8 text-center bg-gradient-to-t from-[#170e10] to-transparent">
