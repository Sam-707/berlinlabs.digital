...
const ItemDetailView: React.FC<ItemDetailViewProps> = ({ item, onClose, onAddToCart }) => {
  ...
  return (
    <div className="fixed inset-0 z-[60] bg-black animate-fade-in flex flex-col max-w-md mx-auto">
      ...
      <div className="relative flex-1 -mt-12 flex flex-col bg-[#170e10] rounded-t-[3rem] shadow-[0_-20px_60px_rgba(0,0,0,0.8)] z-10 overflow-hidden border-t border-white/5">
        ...
        <div className="flex-1 overflow-y-auto px-8 pt-6 pb-36 no-scrollbar">
          ...
          <div className="text-3xl font-black text-primary mb-8 tracking-tight">
          ...
          <div className="flex flex-wrap gap-2.5 mb-10">
            {item.isSpicy && (
              <div className="flex items-center gap-2 px-4 py-2 bg-primary/10 border border-primary/20 rounded-xl text-primary text-[11px] font-black uppercase tracking-widest">
            ...
            <div>
               ...
               <div className="grid grid-cols-2 gap-3">
                  {item.allergens?.map(allergen => (
                    <div key={allergen} className="flex items-center gap-3 p-4 bg-[#241619] rounded-[1.25rem] border border-white/5 shadow-xl">
                  ...
                  {item.containsPeanuts && (
                    <div className="flex items-center gap-3 p-4 bg-[#241619] rounded-[1.25rem] border border-white/5 shadow-xl">
                      <div className="size-8 rounded-full bg-white/5 flex items-center justify-center text-amber-500/80">
