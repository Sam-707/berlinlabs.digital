      ...
      <main className="flex-1 p-6 space-y-8 overflow-y-auto no-scrollbar pb-32">
        ...
        <section className="space-y-4">
          ...
          <div className="grid grid-cols-3 gap-3 lg:gap-6">
            <div className="bg-[#241619] p-4 rounded-2xl border border-white/5 text-center">
        ...
        <section className="space-y-4">
          ...
          {loading ? (
            <div className="bg-[#241619] rounded-2xl border border-white/5 p-8 text-center">
            ...
            <div className="space-y-3 lg:grid lg:grid-cols-2 lg:gap-4 lg:space-y-0">
              {restaurants.map((restaurant) => (
                <div
                  key={restaurant.id}
                  className="bg-[#241619] rounded-2xl border border-white/5 p-4 flex items-center gap-4"
                >
