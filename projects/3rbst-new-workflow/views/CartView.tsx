...
const CartView: React.FC<CartViewProps> = ({ cart, menu, onClose, onRemove, onUpdateQuantity, onCheckout }) => {
      ...
      <div className="bg-background-dark w-full h-[85%] rounded-t-[2rem] shadow-2xl flex flex-col animate-slide-up">
                  ...
                  <div className="flex-1 min-w-0 flex flex-col justify-between self-stretch py-1">
                    <div className="flex justify-between items-start gap-2">
                      ...
                      <div className="text-right shrink-0">
                        <span className="text-primary font-bold text-base">€{lineTotal.toFixed(2)}</span>
                    ...
                    <div className="flex justify-between items-end mt-2">
                      ...
                      <div className="flex items-center bg-[#1a0f10] rounded-full p-1 gap-3 border border-white/5">
                        ...
                        <button
                          ...
                          className="w-7 h-7 rounded-full bg-primary text-white flex items-center justify-center hover:bg-red-700 active:scale-90 shadow-lg shadow-primary/20"
                        >
        ...
        {cart.length > 0 && (
          <div className="bg-background-dark px-6 pt-6 pb-12 border-t border-white/5 shrink-0 shadow-2xl">
            ...
            <button
              onClick={onCheckout}
              className="w-full flex items-center justify-center gap-3 h-14 rounded-full bg-primary text-white text-lg font-bold tracking-wide shadow-lg shadow-primary/25 active:scale-[0.98]"
            >
